...
def imputazione(combined_df, target_column='Transported'):
    ...
    df_train_encoded, df_val_encoded, df_test_encoded = missing_values(combined_df, output_train, output_val, output_test)
    ...
    # oppure puoi usare random_forest come alternativa
